...
<div class="d-flex justify-content-end mb-4">
    <a href="{{ route('admin.coupons.create') }}" class="btn btn-brand"><i class="bi bi-plus"></i> New Coupon</a>
</div>
        ...
        <tbody>
            @forelse($coupons as $coupon)
                <tr>
                    ...
                    <td class="text-end">
                        <a href="{{ route('admin.coupons.edit', $coupon) }}" class="btn btn-icon-circle"><i class="bi bi-pencil"></i></a>
                        <form action="{{ route('admin.coupons.destroy', $coupon) }}" method="POST" class="d-inline" data-confirm="Delete this coupon?">
                            @csrf @method('DELETE')
