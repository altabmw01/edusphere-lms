        ...
        <div class="row g-4">
            <div class="col-lg-7">
                <form method="POST" action="{{ route('checkout.store.course') }}" id="checkoutForm">
                    ...
                    <div class="filter-card">
                        ...
                        <p class="small text-muted mb-4">This course has upcoming batches. Choose the one that fits your schedule.</p>
            ...
            <div class="col-lg-5">
                <div class="filter-card">
                    ...
                    <a href="{{ route('courses.index') }}" class="btn btn-outline-brand w-100"><i class="bi bi-arrow-left me-1"></i> Continue Shopping</a>
