...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('manager.books.create') }}" class="btn btn-brand"><i class="bi bi-plus"></i> New Book</a>
</div>
        ...
        <tbody>
            @forelse($books as $book)
                <tr>
                    ...
                    <td class="text-end">
                        <a href="{{ route('manager.books.edit', $book) }}" class="btn btn-icon-circle"><i class="bi bi-pencil"></i></a>
                        <form action="{{ route('manager.books.destroy', $book) }}" method="POST" class="d-inline" data-confirm="Delete this book?">
                            @csrf @method('DELETE')
